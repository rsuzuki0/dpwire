...
P3 will produce a daily-use, PDF-only release. It includes profile onboarding,
...
After P3, the PDF core will be used without major feature expansion for a soak
...
remain valid architectural reservations, but they do not determine P3 scope or
schedule.
